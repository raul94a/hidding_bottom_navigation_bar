...
///
/// For a sample on how to use these, please see [FlexibleBottomNavigationBar].
/// See also:
///
///  * [FlexibleBottomNavigationBar]
///  * [FlexibleBottomNavigationBarItem]
///  * <https://material.io/design/components/bottom-navigation.html#specs>
enum FlexibleBottomNavigationBarType {
  /// The [FlexibleBottomNavigationBar]'s [FlexibleBottomNavigationBarItem]s have fixed width.
  fixed,

  /// The location and size of the [FlexibleBottomNavigationBar] [FlexibleBottomNavigationBarItem]s
  /// animate and labels fade in when they are tapped.
  shifting,
}

/// Refines the layout of a [FlexibleBottomNavigationBar] when the enclosing
/// [MediaQueryData.orientation] is [Orientation.landscape].
enum FlexibleBottomNavigationBarLandscapeLayout {
...
/// where it is provided as the [Scaffold.FlexibleBottomNavigationBar] argument.
///
/// The bottom navigation bar's [type] changes how its [items] are displayed.
/// If not specified, then it's automatically set to
/// [FlexibleBottomNavigationBarType.fixed] when there are less than four items, and
/// [FlexibleBottomNavigationBarType.shifting] otherwise.
///
/// The length of [items] must be at least two and each item's icon and title/label
/// must not be null.
///
///  * [FlexibleBottomNavigationBarType.fixed], the default when there are less than
...
///  * [FlexibleBottomNavigationBarType.shifting], the default when there are four
...
///    [FlexibleBottomNavigationBarItem.backgroundColor] of the selected item. In this
///    case it's assumed that each item will have a different background color
///    and that background color will contrast well with white.
///
/// {@tool dartpad}
/// This example shows a [FlexibleBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [FlexibleBottomNavigationBar] has three [FlexibleBottomNavigationBarItem]
/// widgets, which means it defaults to [FlexibleBottomNavigationBarType.fixed], and
...
/// {@tool dartpad}
/// This example shows a [FlexibleBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [FlexibleBottomNavigationBar] has four [FlexibleBottomNavigationBarItem]
/// widgets, which means it defaults to [FlexibleBottomNavigationBarType.shifting], and
/// the [currentIndex] is set to index 0. The selected item is amber in color.
/// With each [FlexibleBottomNavigationBarItem] widget, backgroundColor property is
/// also defined, which changes the background color of [FlexibleBottomNavigationBar],
...
///
/// {@tool dartpad}
/// This example shows [FlexibleBottomNavigationBar] used in a [Scaffold] Widget with
/// different interaction patterns. Tapping twice on the first [FlexibleBottomNavigationBarItem]
/// uses the [ScrollController] to animate the [ListView] to the top. The second
/// [FlexibleBottomNavigationBarItem] shows a Modal Dialog.
///
...
class FlexibleBottomNavigationBar extends StatefulWidget {
  /// Creates a bottom navigation bar which is typically used as a
  /// [Scaffold]'s [Scaffold.FlexibleBottomNavigationBar] argument.
  ///
  /// The length of [items] must be at least two and each item's icon and label
  /// must not be null.
  ///
  /// If [type] is null then [FlexibleBottomNavigationBarType.fixed] is used when there
  /// are two or three [items], [FlexibleBottomNavigationBarType.shifting] otherwise.
  ///
  ...
  ///
  /// If [showSelectedLabels] is `null`, [FlexibleBottomNavigationBarThemeData.showSelectedLabels]
  /// is used. If [FlexibleBottomNavigationBarThemeData.showSelectedLabels]  is null,
  /// then [showSelectedLabels] defaults to `true`.
  ///
  /// If [showUnselectedLabels] is `null`, [FlexibleBottomNavigationBarThemeData.showUnselectedLabels]
  /// is used. If [FlexibleBottomNavigationBarThemeData.showSelectedLabels] is null,
  /// then [showUnselectedLabels] defaults to `true` when [type] is
  /// [FlexibleBottomNavigationBarType.fixed] and `false` when [type] is
  /// [FlexibleBottomNavigationBarType.shifting].
  FlexibleBottomNavigationBar({
    super.key,
    required this.items,
    this.onTap,
  ...
  /// track of the index of the selected [FlexibleBottomNavigationBarItem] and call
  ...
  /// Defines the layout and behavior of a [FlexibleBottomNavigationBar].
  ///
  /// See documentation for [FlexibleBottomNavigationBarType] for information on the
  ...
  ///
  /// If [type] is [FlexibleBottomNavigationBarType.shifting] and the
  /// [items] have [FlexibleBottomNavigationBarItem.backgroundColor] set, the [items]'
  /// backgroundColor will splash and overwrite this color.
  final Color? backgroundColor;

  /// The size of all of the [FlexibleBottomNavigationBarItem] icons.
  ///
  /// See [FlexibleBottomNavigationBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [FlexibleBottomNavigationBarItem.icon] and
  /// [FlexibleBottomNavigationBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color? selectedItemColor;

  /// The color of the unselected [FlexibleBottomNavigationBarItem.icon] and
  /// [FlexibleBottomNavigationBarItem.label]s.
  ///
  /// If null then the [ThemeData.unselectedWidgetColor]'s color is used.
  final Color? unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [FlexibleBottomNavigationBarItem.icon].
  ///
  ...
  /// [FlexibleBottomNavigationBarItem.icon]s.
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [FlexibleBottomNavigationBarItem] labels when they are
  /// selected.
  final TextStyle? selectedLabelStyle;

  /// The [TextStyle] of the [FlexibleBottomNavigationBarItem] labels when they are not
  /// selected.
  ...
  /// The font size of the [FlexibleBottomNavigationBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the unselected [FlexibleBottomNavigationBarItem]s.
  ...
  ///
  /// If null, then the value of [FlexibleBottomNavigationBarThemeData.mouseCursor] is used. If
  ...
  ///
  /// * [FlexibleBottomNavigationBarLandscapeLayout.spread] - the items are
  ///   evenly spaced and spread out across the available width. Each
  ///   item's label and icon are arranged in a column.
  /// * [FlexibleBottomNavigationBarLandscapeLayout.centered] - the items are
  ///   evenly spaced in a row but only consume as much width as they
  ///   would in portrait orientation. The row of items is centered within
  ///   the available width. Each item's label and icon are arranged
  ///   in a column.
  /// * [FlexibleBottomNavigationBarLandscapeLayout.linear] - the items are
  ///   evenly spaced and each item's icon and label are lined up in a
  ///   row instead of a column.
  ///
  /// If this property is null, then the value of the enclosing
  /// [FlexibleBottomNavigationBarThemeData.landscapeLayout is used. If that
  /// property is also null, then
  /// [FlexibleBottomNavigationBarLandscapeLayout.spread] is used.
  ///
  /// This property is null by default.
  ///
  /// See also:
  ///
  ///  * [ThemeData.FlexibleBottomNavigationBarTheme] - which can be used to specify
  ///    bottom navigation bar defaults for an entire application.
  ///  * [FlexibleBottomNavigationBarTheme] - which can be used to specify
  ///    bottom navigation bar defaults for a widget subtree.
  ///  * [MediaQuery.of] - which can be used to determine the current
  ///    orientation.
  final BottomNavigationBarLandscapeLayout? landscapeLayout;

  /// This flag is controlling how [FlexibleBottomNavigationBar] is going to use
  ...
  @override
  State<FlexibleBottomNavigationBar> createState() => _FlexibleBottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // The effective tool tip message to be shown on the FlexibleBottomNavigationBarItem.
    ...
    switch (type) {
      case FlexibleBottomNavigationBarType.fixed:
        size = 1;
        break;
      case FlexibleBottomNavigationBarType.shifting:
...
// FlexibleBottomNavigationBarLandscapeLayout.linear then return a
...
class _Tile extends StatelessWidget {
 const  _Tile({
  ...
  Widget build(BuildContext context) {
    ...
    if (data.orientation == Orientation.landscape && layout == FlexibleBottomNavigationBarLandscapeLayout.linear) {
      return Align(
        heightFactor: 1,
        child: Row(
...
class _FlexibleBottomNavigationBarState extends State<FlexibleBottomNavigationBar> with TickerProviderStateMixin {
  ...
  // [FlexibleBottomNavigationBarType.fixed] for 3 or fewer items, and
  // [FlexibleBottomNavigationBarType.shifting] is used for 4+ items.
  FlexibleBottomNavigationBarType get _effectiveType {
    return widget.type
      ?? (widget.items.length <= 3 ? FlexibleBottomNavigationBarType.fixed : FlexibleBottomNavigationBarType.shifting);
  }

  // Computes the default value for the [showUnselected] parameter.
  //
  // Unselected labels are shown by default for [FlexibleBottomNavigationBarType.fixed],
  // and hidden by default for [FlexibleBottomNavigationBarType.shifting].
  ...
  @override
  void didUpdateWidget(FlexibleBottomNavigationBar oldWidget) {
...
// FlexibleBottomNavigationBarLandscapeLayout.centered
class _Bar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (data.orientation == Orientation.landscape && layout == FlexibleBottomNavigationBarLandscapeLayout.centered) {
      alignedChild = Align(
        alignment: Alignment.bottomCenter,
        heightFactor: 1,
        child: SizedBox(
...
class _Circle {
  ...
  final _FlexibleBottomNavigationBarState state;
  final int index;
  final Color color;
